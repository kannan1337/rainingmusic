/**
   RainMusic class that inherits the Music class.
   It holds the tune to be played when the weather is Rain, Drizzle,
   or Thunderstorm, method to play the intro music from its super class,
...
public class RainMusic extends Music
{
   // Set of notes that are exclusive to this child class
   // to be played when weather is rain/drizzle/thunderstrom
   private String tune;
   ...
   /**
      ...
      set the music notes specific to the rain class.
   */
   public RainMusic()
   {
   ...
   */
   ...
   public void play()
   {
      ...
      System.out.println("\nPlaying Rain Music tune with current settings..");
